...
```{r protein-first-mechanism, echo=FALSE, out.width='100%', fig.cap='Conceptual mechanism of Protein-First and Peptide World theories. Primitive peptides may have supported early catalysis and chemical organization before nucleic-acid heredity emerged.'}
knitr::include_graphics("figures/09_protein_first_mechanism.png")
```
...
```{r protein-performance, echo=FALSE}
knitr::kable(
  data.frame(
    Challenge = c(
      "Abiotic synthesis",
  ...
  caption = "Comparative performance of Protein-First and Peptide World theories across major abiogenesis challenges."
)
```
