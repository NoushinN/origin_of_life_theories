...
```{r metabolism-first-overview, echo=FALSE, out.width='100%', fig.cap='Conceptual mechanism of metabolism-first and hydrothermal vent theories.'}
knitr::include_graphics("figures/05_metabolism_first.png")
```
...
```{r hydrothermal-vent-schematic, echo=FALSE, out.width='100%', fig.cap='Hydrothermal vent schematic illustrating geochemical gradients, catalytic surfaces, and potential pathways for prebiotic chemistry.'}
