...
```{r panspermia-pipeline, echo=FALSE, out.width='100%', fig.cap='Lithopanspermia transfer pipeline from impact ejection to Earth arrival.'}
knitr::include_graphics("figures/09_panspermia_transfer_pipeline.png")
```

This figure reframes panspermia as a testable physical sequence.

```{r panspermia-bottlenecks, echo=FALSE, out.width='90%', fig.cap='Relative survival challenges in lithopanspermia. Radiation and long transit time are likely stronger bottlenecks than cold alone.'}
knitr::include_graphics("figures/10_panspermia_survival_bottlenecks.png")
```
