...
```{r four-hurdles, echo=FALSE, out.width='100%', fig.cap='Four major hurdles that any comprehensive origin-of-life theory must address.'}
knitr::include_graphics("figures/02_hurdles_abiogenesis.png")
```
...
```{r pathway-timeline, echo=FALSE, out.width='100%', fig.cap='Simplified pathway showing major proposed stages in the transition from geochemistry to biological evolution and examples of theories associated with each stage.'}
knitr::include_graphics("figures/03_origin_pathway_timeline.png")
```
