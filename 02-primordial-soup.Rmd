...
```{r primordial-soup-pathway-fig, echo=FALSE, fig.align='center', out.width='100%', fig.cap='Conceptual mechanism of the primordial soup model.'}
knitr::include_graphics("figures/04_primordial_soup_pathway.png")
```
